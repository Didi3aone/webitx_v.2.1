<div id="account_role" class="tab-pane active">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                <div class="tabs tabs-center">
                    <ul class="nav nav-tabs nav-justified flex-column flex-md-row justify-content-center">
                        <li class="nav-item active">
                            <a class="nav-link" href="#seller" data-toggle="tab">
                                <p style="color: black; font-size: 28px; margin-top: 10px;">Seller</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#buyer" data-toggle="tab">
                                <p style="color: black;font-size: 28px; margin-top: 10px;">Buyer</p>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="seller" class="tab-pane active">
                            <form class="form-horizontal" id="forms_seller" method="POST" action="<?php echo site_url('member/submit_seller') ?>" enctype="multipart/form-data">
                                ...
                                <br>
                                <div class="pre-scrollable" style="height: 150px; width: 100%;">
                                    <p>
                                ...
                                <p>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="agree_policy_check_seller" class="custom-control-input" id="agree_policy_check_seller" value="YES">
                                            <label class="custom-control-label text-2" for="agree_policy_check_seller">I have read and agree to the <b> privacy policy </b> and <b>disclaimer</b> </label>
                                ...
                                <p>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-submit-seller btn-modern float-right btn-submit " data-loading-text="Loading...">Request</button>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                </p>
                            </form>
                        ...
                        <div id="buyer" class="tab-pane">
                            <form class="form-horizontal" id="forms" method="POST" action="<?php echo site_url('member/submit_buyer') ?>" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="form-group col-lg-12">
                                        <label class="font-weight-bold text-dark text-2">
                                           Pilih Tipe Buyer  <span class="wajib">*</span>
                                        </label>
                                        <select name="buyer_type" id="buyer_type" class="form-control buyer-tipe-select">
                                ...
                                <div class="row">
                                    <div class="card-body" id="form-api" style="display: none;">
                                        <div class="accordion without-bg without-borders" id="accordion8">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="card-body pre-scrollable" style="height: 200px; width: 100%;">
                                                            <p class="mb-0">
                                                                ...
                                                                <p class="text-center ex3">
                                                                    ...
                                                                    Perjanjian Kerahasiaan ini (selanjutnya disebut “Perjanjian”) ditandatangani pada tanggal <?php echo dateToIndo($today); ?> (selanjutnya disebut “Tanggal Efektif”) oleh dan antara: <br>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-lg-6">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="agree_nda_check" class="custom-control-input" id="agree_nda_check" value="YES" >
                                                                    <label class="custom-control-label text-2" for="agree_nda_check">
                                            ...
                                            <div class="card card-default">
                                                ...
                                                <div id="collapse8Two" class="collapse show">
                                                    <div class="card-body">
                                                        <p class="mb-0">
                                                            <section class="card card-admin">
                                                                <header class="card-header" style="background-color: #257afb;">
                                                                    <div class="card-actions">
                                                                        <a href="#" class="card-action card-action-toggle" data-card-toggle></a>
                                                                        <a href="#" class="card-action card-action-dismiss" data-card-dismiss></a>
                                                                    </div>
                                                                    <h2 class="card-title" style="color: white;">
                                                                        <center><b> IP Registration Form </b></center>
                                                                    </h2>
                                                                </header>
                                                                <br>
                                                                <div class="card-body">
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">
                                                                            Development IP Address (max 2) <span class="wajib">*</span>
                                                                        </label>
                                                                        <div class="col-lg-9">
                                                                            <input class="form-control" name="ip_dev_1" id="ip_dev_1" type="text" placeholder="IP Address (1)">
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <input class="form-control" name="ip_dev_2" id="ip_dev_2"type="text" placeholder="IP Address (2)">
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Production IP Address (only 1) <span class="wajib">*</span></label>
                                                                        <div class="col-lg-9">
                                                                            <input class="form-control" name="ip_production" id="ip_production" type="text" placeholder="Production IP Address (only 1)">
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>  
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Protocols <span class="wajib">*</span></label>
                                                                        <div class="col-lg-9">
                                                                            <input class="form-control"  name="protocols" id="protocols" type="text" placeholder="Protocols">
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Ports <span class="wajib">*</span></label>
                                                                        <div class="col-lg-9">
                                                                            <input class="form-control" id="ports" name="ports" type="text" placeholder="Ports">
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Any others related information (optional)  <span class="wajib">*</span></label>
                                                                        <div class="col-lg-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">
                                                                            Request  <span class="wajib">*</span>
                                                                        </label>
                                                                        <div class="col-lg-6">
                                                                            <label class="checkbox-inline">
                                                                                <input type="radio" checked="checked" name="change_request" id="change_request" value="1" > Permanent
                                                                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                            </label>
                                                                            <label class="checkbox-inline">
                                                                    ...
                                                                    <div class="temporary" style="display: none;">
                                                                        <div class="form-group row">
                                                                            <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Start Date <span class="wajib">*</span></label>
                                                                            <div class="col-lg-9">
                                                                                <input class="form-control datepickers" id="temp_start_date" name="temp_start_date" type="text" placeholder="Start Date">
                                                                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">End Date <span class="wajib">*</span></label>
                                                                            <div class="col-lg-9">
                                                                                <input class="form-control datepickers" id="temp_end_date" name="temp_end_date" type="text" placeholder="End Date">
                                                                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input type="checkbox" name="agree_ip_whitelist" class="custom-control-input" id="agree_ip_whitelist">
                                                                            <label class="custom-control-label text-2" for="agree_ip_whitelist">Agree with the terms and conditions</label>
                                                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="agree_policy_check_buyer" class="custom-control-input" value="YES" id="agree_policy_check_buyer">
                                            <label class="custom-control-label text-2" for="agree_policy_check_buyer">
                                                I have read and agree to the <b> privacy policy </b> and <b>disclaimer</b> 
                                            </label> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-submit btn-modern float-right btn-submit " data-loading-text="Loading...">Request</button>&nbsp;&nbsp;
                                    </div>
                                </div>
                            </form>
                        </div>
