...
class Ion_auth_model extends CI_Model
{
	...
	public function __construct()
	{
		...
		$this->identity_admin = $this->config->item('identity_admin', 'ion_auth');
	 ...
	 * @author    Mathew
	 */
	public function login($identity, $password, $remember=FALSE, $type=FALSE)
	{
		...
		// $identity_column = $type ? $type : $this->identity_column;
